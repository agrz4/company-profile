...
export const businessLines: BusinessLine[] = [
  {
    ...
    descriptionId: 'Perdagangan besar padi, jagung, kedelai, dan palawija berkualitas tinggi dari petani lokal pilihan.',
  ...
  },
  {
    ...
    descriptionId: 'Perdagangan skala besar buah yang mengandung minyak, termasuk kelapa tua, kelapa sawit, dan kemiri.',
    category: 'agriculture',
    icon: 'Droplet'
  },
  {
    ...
    descriptionId: 'Penyediaan produk tembakau rajangan kualitas premium yang diperoleh langsung dari perkebunan lokal.',
    category: 'agriculture',
    icon: 'Leaf'
  },
  {
    ...
    descriptionId: 'Perdagangan besar dan distribusi hewan ternak hidup bersertifikasi kesehatan untuk pasar domestik dan ekspor.',
    category: 'agriculture',
    icon: 'Beef'
  },
  {
    ...
    descriptionId: 'Distribusi ikan segar/hidup, ikan hias, dan biota air lainnya dengan manajemen logistik transit optimal.',
    category: 'agriculture',
    icon: 'Fish'
  },
  {
    ...
    descriptionId: 'Perdagangan produk kayu berkelanjutan, getah damar, bambu, rotan, dan hasil hutan non-kayu lainnya.',
    category: 'forestry',
    icon: 'Trees'
  },
  {
    ...
    descriptionId: 'Ekspor dan distribusi rempah-rempah (pala, cengkeh, lada), biji kopi, cokelat, dan pakan ternak khusus.',
    category: 'agriculture',
    icon: 'Sprout'
  },
  {
    ...
    descriptionId: 'Perdagangan sumber daya energi, batubara, briket arang batok kelapa, biomassa, dan bahan bakar minyak.',
    category: 'energy',
    icon: 'Flame'
  },
  {
    ...
    descriptionId: 'Distribusi crude palm oil (CPO), minyak kelapa olahan (RBD CNO), minyak goreng, dan lemak nabati industri.',
    category: 'agriculture',
    icon: 'Container'
  },
  {
